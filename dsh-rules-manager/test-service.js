...
// 运行：node "D:\example workspace\.dsh\profiles\web\rules-manager\test-service.js"
...
await copyFile("D:/example workspace/.dsh/AGENTS.md", join(home, "AGENTS.md"));
...
t("remoteMethods 标记 8 个方法", methods.length === 8);
for (const m of ["listRules", "addRule", "editRule", "deleteRule", "listCommands", "listUserCommands", "saveUserCommand", "deleteUserCommand"]) {
